...
**479 hands-on visualizations** you can poke, drag, and break — spanning networking,
...
[![Sections](https://img.shields.io/badge/sections-479-8250df?style=flat-square)](#whats-inside)
...
**479 interactive sections across 12 areas** — plus **guided journeys** (curated end-to-end walks like
...
npm run test:run        # run the full test suite (CI runs it on every push)
