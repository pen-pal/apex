...
export function AslrSection() {
  ...
  const scenes: StoryScene[] = [
    ...
    scene('win', 'Recompute, and win', 'With the leaked base you recompute every address: system() = base + 0x4f420, "/bin/sh" = base + offset. Rebuild the chain with the correct runtime addresses and it hits system() exactly. ASLR with no leak is genuinely strong; ASLR plus one leaked address is defeated.', R2, true, 'win'),
