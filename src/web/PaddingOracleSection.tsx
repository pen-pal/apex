...
export function PaddingOracleSection() {
  ...
  const scenes: StoryScene[] = [
    ...
    scene('whole', 'The whole block, no key', 'Repeat across the block and every byte is recovered in a few hundred oracle queries. The block cipher was never broken and the key was never touched; the server simply answered one yes/no question too many times.'),
