...
// rings cleanly (eps=0.09 → 2 clusters, 2 noise) while k-means slices them down the middle (~57%). Sensitive to eps
// (0.04 → fragments into 15, 0.09 → 2). Non-convex clusters + outlier detection. Interactive. Sandboxed/CONCEPTUAL.
