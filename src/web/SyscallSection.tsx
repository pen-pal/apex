...
export function SyscallSection() {
  ...
  const scenes: StoryScene[] = [
    ...
    narrated('switch', 'Mode switch', 'The CPU flips from ring 3 to ring 0, saves the program’s registers, and jumps to a single fixed entry point the kernel installed at boot. The program cannot choose where it lands — that is the whole point of the wall.'),
