...
export function ContainerSection() {
  ...
  const scenes: StoryScene[] = [
    ...
    narrated('together', 'That is all a container is', 'Namespaces (what it sees) + cgroups (what it uses) + an image (its files) = a container. One shared kernel, many isolated processes. No guest OS to boot is exactly why a container starts in milliseconds where a VM takes seconds.'),
