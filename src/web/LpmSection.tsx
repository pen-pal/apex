...
export function LpmSection() {
  ...
  const scenes: StoryScene[] = [
    ...
    narrated('match', 'Several entries match', 'For 10.1.2.99, all four entries match at once: the /0 default, 10.0.0.0/8, and 10.1.0.0/16 — and 10.1.2.0/24 as well. So which port does the packet take?'),
