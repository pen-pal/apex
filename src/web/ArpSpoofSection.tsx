...
export function ArpSpoofSection() {
  ...
  return (
    <GuidedStory
      scenes={scenes}
      explain={{
        idea: <>You met ARP a few rungs back — to send a packet on the same LAN your computer needs the target’s MAC, so it broadcasts “who has 192.168.1.1?” and caches whoever answers “I do, at this MAC.” Here you cash in the flaw that rung flagged: ARP has no authentication at all — any host can answer, and can even volunteer an answer nobody asked for (a <em>gratuitous</em> ARP). So an attacker on your network just announces “the gateway is at MY MAC,” your machine believes it, and everything you send toward the internet goes to the attacker instead.</>,
