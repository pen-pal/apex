...
export const GROUPS: SectionGroup[] = [
  ...
  { label: 'Data & encoding', icon: '🔤', ids: ['encoding', 'float', 'varint', 'base58', 'linecode', 'lz77', 'lzw', 'bwt', 'mtf', 'cdc', 'rsync', 'dfa', 'huffman', 'jpeg', 'interframe', 'mp3', 'dithering', 'gamma', 'golombrice', 'eliascode', 'gorilla', 'cobs', 'arith', 'crc32', 'hamming', 'reedsolomon', 'viterbi', 'errors', 'barcode'] },
