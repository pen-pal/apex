...
export const GROUPS: SectionGroup[] = [
  ...
  { label: 'Storage & databases', icon: '🗄️', ids: ['btree', 'lsm', 'pagereplace', 'mvcc', 'wal', 'skiplist', 'locking', 'joins', 'trie', 'hashtable', 'cuckoo', 'geohash', 'unionfind', 'fenwick', 'heap', 'segtree', 'avl', 'sorting', 'kmp', 'rabinkarp', 'editdist', 'toposort', 'astar', 'maxflow', 'mst'] },
  { label: 'Systems & OS', icon: '🖥️', ids: ['cpusched', 'cfs', 'pagewalk', 'mesi', 'tso'] },
];
