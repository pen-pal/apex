...
export const GROUPS: SectionGroup[] = [
  ...
  { label: 'Cryptography', icon: '🔒', ids: ['crypto', 'aesround', 'feistel', 'aead', 'chacha', 'poly1305', 'hashint', 'rsa', 'ecc', 'ecdsa', 'dhmitm', 'tlsdowngrade', 'pwhash', 'pqc', 'shamir', 'pow', 'ratchet', 'merkle'] },
