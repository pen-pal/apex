...
export const GROUPS: SectionGroup[] = [
  ...
  { label: 'Security & web', icon: '🛡️', ids: ['certs', 'kerberos', 'revocation', 'ssh', 'identity', 'mailauth', 'webauthn', 'cookies', 'cors', 'webinject', 'smuggle', 'ssrf', 'clickjack', 'hsts', 'openredirect', 'hashflood', 'siteisolation', 'sri', 'csp', 'attacks'] },
