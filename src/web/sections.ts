...
export const GROUPS: SectionGroup[] = [
  ...
  { label: 'Security & web', icon: '🛡️', ids: ['certs', 'kerberos', 'revocation', 'ssh', 'identity', 'jwt', 'mailauth', 'webauthn', 'cookies', 'cors', 'webinject', 'bufferoverflow', 'smuggle', 'ssrf', 'xxe', 'dnsrebind', 'arpspoof', 'clickjack', 'hsts', 'openredirect', 'protopollute', 'hashflood', 'redos', 'subdomain', 'siteisolation', 'sri', 'csp', 'attacks'] },
