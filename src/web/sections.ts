...
export const GROUPS: SectionGroup[] = [
  ...
  { label: 'Systems & OS', icon: '🖥️', ids: ['cpusched', 'cfs', 'priorityinv', 'cpucycle', 'compiler', 'bytecode', 'jit', 'pipeline', 'branchpredict', 'oooexec', 'spectre', 'cow', 'pagewalk', 'pagefault', 'inode', 'tlb', 'numa', 'buddyalloc', 'gc', 'timingwheel', 'epoll', 'syscall', 'container', 'breakpoint', 'futex', 'rcu', 'aba', 'seqlock', 'iouring', 'bakery', 'mesi', 'falseshare', 'tso'] },
