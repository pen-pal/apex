...
export const EXTRA_PATHS: LearningPath[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'paillier', note: 'Add numbers while they stay encrypted: Paillier is additively homomorphic — multiply two ciphertexts and you get the encryption of their sum, so a server can total values it can’t read — the engine behind private voting and aggregation.' },
