...
// dense below) for O(log n) at scale. Real best-first search verified in node: recall@1 rises 91%→99.8% as ef 1→16,
// visiting <20% of the vectors. Pairs with the word2vec story (embeddings are the vectors). Sandboxed/CONCEPTUAL, 2-D.
